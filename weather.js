...
function svgbutton(elem, text1, text2) {
  ...
  elem.append("rect") // transparent overlay to catch mouse events
    ...
    .attr("y", y0)
    .attr("ry", height / 2)
    .on("click", runningButton); // This restarts analysis (defined in weak.js)
  ...
  //   d3.select(".button-off#but_" + e.name).on("click", runningButton);
  ...
  //     .transition()
  //     .call(function() {
  //   let backgroud = d3.select("#but_" + e.name)
  //   // backgroud.style("fill-opacity", 1)
  //   backgroud.classed("button-on", !backgroud.classed("button-on")); 
  //   backgroud.classed("button-off", !backgroud.classed("button-off")); 
  //     });
  // };
